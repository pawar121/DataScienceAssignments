...
def main():
    ...
    if (response.url == 'https://www.lendingclub.com/account/summary.action'):
        ...
        logger.info("Looking for declined-loan-stats data..")
        ...
        logger.info("Total number of declined-loan-stats data files : " + str(len(loanStats)))


        #downloading Loan Stats Data
        logger.info("Downloading declined-loan-stats data files...")
        ...
        luigi_completion_text_file = fileDir+'/Luigi/download_declined_loan_data_completed.txt'
...
class Download_declined_loan_data(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget('Luigi/download_declined_loan_data_completed.txt')
